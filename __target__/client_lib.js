// Transcrypt'ed from Python, 2019-05-11 16:52:29
...
export var BLACKOUTS = 'hsl(0,50%,5%, 0.5)';
...
export var draw_calendar = function () {
	...
	for (var [idx, user] of enumerate (status.py_keys ())) {
		...
		for (var b of blackouts) {
			...
			var bottom = ((1 + hr2) + min2 / 60) / 25;
			print ('blackouts', b);
			draw_rect (tuple ([left, top, right, bottom]), BLACKOUTS);
		}
	}
